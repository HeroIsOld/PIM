...
namespace PIM
{
    public partial class buy : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string sql1 = "insert into dbo.T_ORDER (TYPE,SELLER_ID,CREATED_DATA,COMMENT,CREATED_USER,CLIENT_NAME,CLIENT_TEL) values ('BUY',null,getdate(),'"+richTextBox1.Text+"','"+info.Username+ "',null,null ); select @@IDENTITY";
